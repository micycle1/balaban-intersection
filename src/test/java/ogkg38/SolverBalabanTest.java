...
public class SolverBalabanTest {
	 ...
	 */
	/*
	 * @Test public void testSplit() { System.out.println("split"); double b = 0.0;
	 * double e = 0.0; Collection<Segment> l = null; Collection<Segment> q = null;
	 * Collection<Segment> l1 = null; SolverBalaban instance = null;
	 * instance.split(b, e, l, q, l1); // TODO review the generated test code and
	 ...
	 */
	/*
	 * @Test public void testFindIntersectionSorted() {
	 * System.out.println("findIntersectionSorted"); double b = 0.0; double e = 10;
	 * double x = 5; Collection<Segment> d = null; Collection<Segment> s = null;
	 * SolverBalaban instance = null; instance.findIntersectionSorted(b, e, x, d,
	 * s); // TODO review the generated test code and remove the default call to
	...
	public void testIntersectingPairsIntermediate() {
		...
		for (int i = 0; i < 5; i++) {
			...
			/*
			 * System.out.println(tr+" "+dd[0]) ; if (tr!=dd[0]) { dd[0]=0;
	...
	public void testSearchInStrip() {
		...
		for (int i = 0; i < 100; i++) {
			...
			List<Segment> d1 = new ArrayList<>(s1);
